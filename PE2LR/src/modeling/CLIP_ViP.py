...
class CLIPOutput(ModelOutput):
    ...
    wo_norm_text: torch.FloatTensor = None
    image_embeds: torch.FloatTensor = None
    wo_norm_vis: torch.FloatTensor = None
...
# attention_mask torch.Size([64, 50])
        ...
        # print('attention_mask', attention_mask.shape)
        # print('causal_attention_mask', causal_attention_mask.shape)
# attention_mask torch.Size([64, 1, 50, 50])
# causal_attention_mask torch.Size([64, 1, 50, 50])
...
class CLIPModel(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        # word_embeds = text_outputs[0] # # pooled: (b,l,dim)
        ...
        # print(vision_patch_embeds.shape) # torch.Size([64, 592, 512])
        wo_norm_text = text_embeds
        wo_norm_vis = image_embeds
        # normalized features
        ...
        return CLIPOutput(
            ...
            wo_norm_text = wo_norm_text,
            image_embeds=image_embeds,
            wo_norm_vis = wo_norm_vis,
